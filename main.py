...
# tips from lecture7
# path compression: instead of jumping through multiple pathways to find
# root, we just re-assign a new pathway directly pointing to root. At a
# constant cost of that extra step, we save ourselves the possibility of a
# larger magnitude cost with large pathways.
...
class graph:
    ...
    # make a new set at each node. Each set consists of parent identifiers and
    # ranking
